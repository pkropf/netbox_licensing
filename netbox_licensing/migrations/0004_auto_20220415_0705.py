...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('netbox_licensing', '0003_auto_20220407_1209'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='netbox_licensing.softwareproduct'),
        ),
        migrations.AlterField(
            model_name='softwareproductinstallation',
            name='version',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='netbox_licensing.softwareproductversion'),
        ),
        migrations.AlterField(
            model_name='softwareproductinstallation',
            name='virtualmachine',
