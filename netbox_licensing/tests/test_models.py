...
class ModelTestCase(TestCase):
    def setUp(self):
        ...
        self.test_url = "https://github.com/ICTU/netbox_licensing"
    ...
    def test_absolute_url(self):
        self.assertEqual("/plugins/licensing/software-products/1/", self.software_product.get_absolute_url())
        self.assertEqual("/plugins/licensing/versions/1/", self.software_product_version.get_absolute_url())
        self.assertEqual("/plugins/licensing/installations/1/", self.software_product_installation.get_absolute_url())
        self.assertEqual("/plugins/licensing/licenses/1/", self.software_license.get_absolute_url())

    def test_get_installation_count(self):
        installation_ss = '<a href="/plugins/licensing/installations/?q={}">1</a>'
