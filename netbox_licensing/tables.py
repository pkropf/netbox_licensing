...
class SoftwareProductTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_licensing:softwareproduct_list")
...
class SoftwareProductVersionTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_licensing:softwareproductversion_list")
...
class SoftwareProductInstallationTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_licensing:softwareproductinstallation_list")
...
class SoftwareLicenseTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_licensing:softwarelicense_list")
