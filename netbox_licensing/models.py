...
class SoftwareProduct(NetBoxModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_licensing:softwareproduct", kwargs={"pk": self.pk})
        ...
        return (
            safestring.mark_safe(
                '<a href="{url}">{count}</a>'.format(
                    url=reverse_lazy("plugins:netbox_licensing:softwareproductinstallation_list") + f"?q={self.name}",
                    count=count,
                )
            )
            if count
...
class SoftwareProductVersion(NetBoxModel):
    ...
    software_product = models.ForeignKey(
        to="netbox_licensing.SoftwareProduct",
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_licensing:softwareproductversion", kwargs={"pk": self.pk})
...
class SoftwareProductInstallation(NetBoxModel):
    ...
    software_product = models.ForeignKey(to="netbox_licensing.SoftwareProduct", on_delete=models.PROTECT)
    version = models.ForeignKey(to="netbox_licensing.SoftwareProductVersion", on_delete=models.PROTECT)
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_licensing:softwareproductinstallation", kwargs={"pk": self.pk})
...
class SoftwareLicense(NetBoxModel):
    ...
    software_product = models.ForeignKey(to="netbox_licensing.SoftwareProduct", on_delete=models.PROTECT)
    version = models.ForeignKey(to="netbox_licensing.SoftwareProductVersion", on_delete=models.PROTECT, null=True, blank=True)
    installation = models.ForeignKey(
        to="netbox_licensing.SoftwareProductInstallation", on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_licensing:softwarelicense", kwargs={"pk": self.pk})
